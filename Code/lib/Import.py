...
def importMeasurement(path: str) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
    """
...
def importImages(path: str) -> tuple[np.ndarray, np.ndarray, list[np.ndarray]]:
    """
...
def getStitchingPreferences(path: str) -> dict:
    """
    ...
    # values specified by the usoft .xml. Might differ for your scope.
    SP['shiftX'] = 432
    SP['shiftY'] = 0
