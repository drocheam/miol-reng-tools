...
def readsmi(path):
    ...
    # these parameters are experimental, since they are not in the documentation
...
def readsms(path):
    """
    loads usoft .sms file and reads image and intensity data
...
def readsmt(path):
    """
    loads usoft .smt file and reads image and intensity data
...
def readnms(path):
    """
    loads usoft .nms file and reads image and intensity data
...
def readorginal(path):
    """
    loads usoft .orginal file and reads image and intensity data
...
def readImages(path, single):
    """
    reads binary .smt and .sms files as generated by usoft
